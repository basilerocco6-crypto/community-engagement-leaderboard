-- Full Supabase Seed Script for User Engagement Table
-- Run this script in Supabase Dashboard > SQL Editor
-- WARNING: This will drop and recreate the user_engagement table

-- Step 1: Drop existing table and all dependent objects safely
DROP TABLE IF EXISTS user_engagement CASCADE;

-- Step 2: Create the user_engagement table with proper structure
...
-- Step 5: Insert seed data with conflict handling
