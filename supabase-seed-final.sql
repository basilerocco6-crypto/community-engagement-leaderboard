-- Final Supabase User Engagement Seed Script ✅
-- Fixes "No rows returned" issue with complete table recreation
-- SAFE: Handles duplicates, clears partial data, creates proper structure

-- 🗑️ STEP 1: Safely remove existing table (fixes partial/broken data)
DROP TABLE IF EXISTS user_engagement CASCADE;

-- 🏗️ STEP 2: Create fresh table with proper structure
...
-- 🌱 STEP 5: Insert seed data with duplicate handling
